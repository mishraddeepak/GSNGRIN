  ...
  return (
    <div className={styles.outerContainer}>
      ...
      <div className={styles.innerContainer}>
        ...
        <NavLink to='/gsn/log-in'><button onClick={() => { handleclick('gsn') }}>GSN</button></NavLink>
        <NavLink to='/attendee/log-in'><button onClick={() => { handleclick('attendee') }}>GRIN</button></NavLink>
